...
(cl:defmethod cl:initialize-instance :after ((m <arm_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'arm_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motor_ctrl-msg:<arm_msg> is deprecated: use motor_ctrl-msg:arm_msg instead.")))

(cl:ensure-generic-function 'base_motor-val :lambda-list '(m))
(cl:defmethod base_motor-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:base_motor-val is deprecated.  Use motor_ctrl-msg:base_motor instead.")
  (base_motor m))

(cl:ensure-generic-function 'link_1-val :lambda-list '(m))
(cl:defmethod link_1-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:link_1-val is deprecated.  Use motor_ctrl-msg:link_1 instead.")
  (link_1 m))

(cl:ensure-generic-function 'link_2-val :lambda-list '(m))
(cl:defmethod link_2-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:link_2-val is deprecated.  Use motor_ctrl-msg:link_2 instead.")
  (link_2 m))

(cl:ensure-generic-function 'link_3-val :lambda-list '(m))
(cl:defmethod link_3-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:link_3-val is deprecated.  Use motor_ctrl-msg:link_3 instead.")
  (link_3 m))

(cl:ensure-generic-function 'waist-val :lambda-list '(m))
(cl:defmethod waist-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:waist-val is deprecated.  Use motor_ctrl-msg:waist instead.")
  (waist m))

(cl:ensure-generic-function 'claw-val :lambda-list '(m))
(cl:defmethod claw-val ((m <arm_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motor_ctrl-msg:claw-val is deprecated.  Use motor_ctrl-msg:claw instead.")
  (claw m))
